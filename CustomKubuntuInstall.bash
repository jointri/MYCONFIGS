...
#This script is to be ran AFTER you setup the partitions and debootstrap 'debootstrap --include=lsb-release,gnupg,wget,git,curl,vim --arch=amd64 jammy <chroot root>'
